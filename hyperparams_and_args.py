...
def get_argparser(experiment="ersstv5"):
    ...
    parser.add_argument("--data_dir", type=str,
                        default=r'C:/Users/salva/OneDrive/Documentos/Projects/ProjectX/Data/')
    ...
    parser.add_argument('--prelu', type=bool, default=False,
    ...
    parser.add_argument('--transfer_epochs', type=int, default=200, help='Only used if transfer learning is done.')
